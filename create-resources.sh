...
echo
#kubectl apply -f- /tmp/crds/com.gunjangarge.operator.mariadb_v1_mariadbbackup_cr.yaml -n $OP
cat << EOF | kubectl apply -f -
apiVersion: com.gunjangarge.operator.mariadb/v1
kind: MariaDBBackup
metadata:
...
# kubectl apply -f- /tmp/crds/com.gunjangarge.operator.mariadb_v1_mariadbrestore_cr.yaml -n $OP
#cat << EOF | kubectl apply -f -
#apiVersion: com.gunjangarge.operator.mariadb/v1
#kind: MariaDBRestore
#metadata:
